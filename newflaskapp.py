...
def environments():
        ...
        # Get articles
        result = cur.execute("SELECT IP, DNS, OS, APPLICATION, SUBAPPLICATION, ENVIRONMENT, sfunction, HTYPE, INFRASTATUS, TIER FROM tablette.ASSETS where infrastatus = 'ACTIVE' and ENVIRONMENT = 'QA3' order by tier,application, environment, subapplication, sfunction, htype, ip")
